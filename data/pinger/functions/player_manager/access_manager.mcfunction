...
# プレイヤー歩行距離スコア更新
execute if score @s Pinger_updated_walk_score_flag matches 0 run function pinger:player_manager/walk_score_updater
...
execute if score @s Pinger_current_walk_score > @s Pinger_last_walk_score run scoreboard players set @s Pinger_updated_walk_score_flag 0
